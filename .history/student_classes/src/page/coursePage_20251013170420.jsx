...
const CoursePage = (props) => {
  ...
  style={{
    width: "100%",
    maxWidth: "100%",
    height: "auto",           // Let height depend on the image's aspect ratio
    maxHeight: "480px",       // Limits height to fit your layout
    borderRadius: "8px",
    boxShadow: "0 2px 8px rgba(0,0,0,0.1)",
    objectFit: "contain",     // Shows the entire image, no cropping
    background: "#fff"        // Optional: ensures clean edge if aspect differs
  }}
/>
        </div>
      </div>
