...
const CoursePage = (props) => {
  ...
  return (
    <div style={{ 
     ...
     <div style={{
  display: "flex",
  maxWidth: "1200px",      // Controls full card width, adjust as needed
  margin: "40px auto",     // Centers the card container
  background: "#f8f9fa",
  borderRadius: "15px",
  ...
  {/* RIGHT COLUMN: Large campus map */}
  <div style={{
    flex: "none",
    width: "600px",     // MAKE THIS BIG for a large map
    display: "flex",
    ...
    <img
      ...
      alt="Campus Map"
      style={{
        width: "600px",      // MAP IMAGE WIDTH
        height: "340px",     // MAP IMAGE HEIGHT
        objectFit: "contain",
        borderRadius: "16px",
        background: "#fff",
