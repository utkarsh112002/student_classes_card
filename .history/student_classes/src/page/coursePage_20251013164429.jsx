        ...
        <div style={{ flex: "0 0 65%", backgroundColor: "white", padding: "2rem", borderRadius: "8px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
          ...
          {courseData && (
            <div style={{ marginBottom: "2rem" }}>
              ...
              {courseData.academicPeriod && courseData.academicPeriod.startOn && courseData.academicPeriod.endOn && (
                <div style={{ 
                  fontSize: "1rem", 
                  color: "#555",
                  marginTop: "1rem",
                  ...
                  <strong>Academic Period:</strong> {formatDate(courseData.academicPeriod.startOn)} - {formatDate(courseData.academicPeriod.endOn)}
                </div>
              )}
            </div>
          )}
